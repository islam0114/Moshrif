...
class DatabaseSeeder:
    ...
    def seed_students(self):
        ...
        students = []
        students.append(('243904758', 'Islam', 'em8756070@gmail.com'))
    ...
    def seed_registrations(self):
        ...
        for student_id in self.students_ids:
            ...
            for course in my_courses:
                if student_id == '243904758' and course[0] == 'CS101': continue 
                registrations.append((student_id, course[0]))
        
        registrations.append(('243904758', 'CS101'))
        registrations.append(('243904758', 'MATH2'))
